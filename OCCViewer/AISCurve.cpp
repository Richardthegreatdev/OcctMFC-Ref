...
void AISCurve::Compute(const Handle(PrsMgr_PresentationManager3d)& aPresentationManager,
...
void AISCurve::Build3DCurve(const Handle(PrsMgr_PresentationManager3d)& aPresentationManager,
	const Handle(Prs3d_Presentation)& thePrs,
	const Standard_Integer aMode)
{
...
void AISCurve::Build2DCurve(const Handle(PrsMgr_PresentationManager3d)& aPresentationManager,
	const Handle(Prs3d_Presentation)& thePrs,
